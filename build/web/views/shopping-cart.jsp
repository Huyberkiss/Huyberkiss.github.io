                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="p-4">
                                ...
                                <div class="input-group mb-4 border rounded-pill p-2">
                                    ...
                                    <input type="text" placeholder="Apply coupon" aria-describedby="button-addon3" name="voucher" class="form-control border-0">
                                    <div class="input-group-append border-0">

                                        <a href="/ProjectPRJ/VoucherController" type="submit" class="btn btn-dark rounded-pill py-2 btn-block">
                                            <i class="fa fa-gift mr-2"></i>Apply coupon</a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="p-4">
                                ...
                                <ul class="list-unstyled mb-4">
                                    ...
                                    <li class="d-flex justify-content-between py-3 border-bottom"><strong class="text-muted">Voucher</strong><strong>0%</strong></li>
